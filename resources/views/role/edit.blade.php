    ...
    @component('components.widget', ['class' => 'box-primary'])
          ...
          <div class="row check_group">
            ...
            <div class="col-md-9">
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'purchase_order.view_own', in_array('purchase_order.view_own', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'purchase_order.view_all', in_array('purchase_order.view_all', $role_permissions), 
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'direct_sell.view', in_array('direct_sell.view', $role_permissions), 
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'so.view_own', in_array('so.view_own', $role_permissions), 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'so.view_all', in_array('so.view_all', $role_permissions), 
        ...
        <div class="row check_group">
            ...
            <div class="col-md-9">
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('permissions[]', 'access_own_shipping', in_array('access_own_shipping', $role_permissions), ['class' => 'input-icheck']); !!}
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('permissions[]', 'all_expense.access', in_array('all_expense.access', $role_permissions), 
