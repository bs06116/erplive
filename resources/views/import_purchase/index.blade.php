...
<section class="content-header">
    <h1>@lang('lang_v1.import_purchases')</h1>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.widget')
                {!! Form::open(['url' => action('ImportPurchaseController@preview'), 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
                    <div class="row">
                        <div class="col-sm-6">
                        <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <br>
                            <a href="{{ asset('files/import_purchase_template.xlsx') }}" class="btn btn-success" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach($imported_purchase_array as $key => $value)
                        <tr>
                            <td>{{$key}}</td>
                            ...
                            @can('sell.delete')
                                <td><a href="{{action('ImportPurchaseController@revertPurchaseImport', $key)}}" class="btn btn-xs btn-danger revert_import"><i class="fas fa-undo"></i> @lang('lang_v1.revert_import')</a></td>
                            @endcan
                        </tr>
                    @endforeach
                </tbody>
