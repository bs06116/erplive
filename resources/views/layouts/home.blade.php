...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        {{-- <link rel="stylesheet" href="{{ asset('new/css/vendor.css') }}"> --}}
        ...
        <link rel="stylesheet" href="{{ asset('new/css/swiper-bundle.css') }}">
        <link rel="stylesheet" href="{{ asset('new/css/dashcore.css') }}">
    ...
    <script src="{{ asset('new/js/feather.js') }}"></script>
    <script src="{{ asset('new/js/jquery.animatebar.js') }}"></script>
    <script src="{{ asset('new/js/site.js') }}"></script>
    @yield('javascript')
    </body>
</html>