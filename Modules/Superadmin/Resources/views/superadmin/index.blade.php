		...
		<div class="row">
	        ...
	        <div class="col-lg-4 col-xs-6">
	          ...
	          <div class="small-box bg-yellow">
	            ...
	            <a href="{{action('\Modules\Superadmin\Http\Controllers\BusinessController@index')}}?date={{now()}}" class="small-box-footer">@lang('superadmin::lang.more_info') <i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
