...
class CrmDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $leads_by_source = $leads->groupBy('crm_source');
        ...
        return view('crm::crm_dashboard.index')->with(compact('total_customers', 'total_leads', 'total_sources', 'total_life_stage', 'leads_by_source', 'leads_by_life_stage', 'sources', 'life_stages', 'todays_birthdays', 'upcoming_birthdays'));
    }
