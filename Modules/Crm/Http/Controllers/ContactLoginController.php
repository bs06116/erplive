...
class ContactLoginController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $users = $query->select('username', 'email', 'id', 'crm_contact_id', 'surname', 'first_name', 'last_name');
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only('crm_contact_id', 'surname', 'first_name', 'last_name', 'email', 'username', 'password');
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $input = $request->only('surname', 'first_name', 'last_name', 'email', 'username');
