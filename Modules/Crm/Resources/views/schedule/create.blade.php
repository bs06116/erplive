                ...
                <div class="row">
                    <div class="col-md-4">
                       <div class="form-group">
                            ...
                            {!! Form::select('status', $statuses, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'style' => 'width: 100%;']); !!}
                       </div>
                    </div>
                    <div class="col-md-4">
                       <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('schedule_type', ['call' => __('crm::lang.call'), 'sms' => __('crm::lang.sms'), 'meeting' => __('crm::lang.meeting'), 'email' => __('business.email')], null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required', 'style' => 'width: 100%;']); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="allow_notification_elements hide">
                        <div class="col-md-6">
                            ...
                            <div class="form-group checkbox-inline">
                                <label>
                                    {!! Form::checkbox('sms', 1, false, ['class' => 'input-icheck']); !!}
                                    @lang('crm::lang.sms')
                                </label>
                            </div>
                            <div class="form-group checkbox-inline">
                                <label>
                                    {!! Form::checkbox('mail', 1, true, ['class' => 'input-icheck']); !!}
                                    @lang('business.email')
                                </label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="multi-input">
                                    ...
                                    {!! Form::select('notify_type', ['minute' => __('crm::lang.minute'), 'hour' => __('crm::lang.hour'), 'day' => __('lang_v1.day')], '', ['class' => 'form-control width-60 pull-left']); !!}
                                </div>
                            </div>
                        </div>
                    </div>
