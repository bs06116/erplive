<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => action('\Modules\Crm\Http\Controllers\ScheduleController@update', ['id' => $schedule->id]), 'method' => 'put', 'id' => 'edit_schedule' ]) !!}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('schedule_type', ['call' => __('crm::lang.call'), 'sms' => __('crm::lang.sms'), 'meeting' => __('crm::lang.meeting'), 'email' => __('business.email')], $schedule->schedule_type, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required', 'style' => 'width: 100%;']); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="allow_notification_elements">
                        <div class="col-md-6">
                            ...
                            <div class="form-group checkbox-inline">
                                <label>
                                    {!! Form::checkbox('sms', 1, $schedule->notify_via['sms'], ['class' => 'input-icheck']); !!}
                                    @lang('crm::lang.sms')
                                </label>
                            </div>
                            <div class="form-group checkbox-inline">
                                <label>
                                    {!! Form::checkbox('mail', 1, $schedule->notify_via['mail'], ['class' => 'input-icheck']); !!}
                                    @lang('business.email')
                                </label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="multi-input">
                                    ...
                                    {!! Form::select('notify_type', ['minute' => __('crm::lang.minute'), 'hour' => __('crm::lang.hour'), 'day' => __('lang_v1.day')], $schedule->notify_type, ['class' => 'form-control width-60 pull-left']); !!}
                                </div>
                            </div>
                        </div>
                    </div>
