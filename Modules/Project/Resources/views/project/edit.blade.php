            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('bounce_date',  !empty($project->bounce_date) ? @format_date($project->bounce_date) : '', ['class' => 'form-control datepicker', 'readonly']); !!}
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('bounce', $project->bounce, ['class' => 'form-control' ]) !!}
                    </div>
                </div>
