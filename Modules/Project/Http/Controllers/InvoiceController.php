...
class InvoiceController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('project::invoice.create')
            ->with(compact('customers', 'invoice_schemes', 'default_scheme', 'project', 'statuses', 'discount_types', 'taxes', 'tax_attributes'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $input = $request->only('pjt_project_id', 'pjt_title', 'contact_id', 'pay_term_number', 'pay_term_type', 'status', 'discount_type', 'staff_note', 'additional_notes');
    ...
    public function edit($id)
    {
        ...
        return view('project::invoice.edit')
            ->with(compact('project', 'customers', 'statuses', 'discount_types', 'transaction', 'taxes', 'tax_attributes'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $input = $request->only('pjt_title', 'contact_id', 'pay_term_number', 'pay_term_type', 'status', 'discount_type', 'staff_note', 'additional_notes');
            $input['transaction_date'] = $this->commonUtil->uf_date($request->input('transaction_date'));
            $input['discount_amount'] = $this->commonUtil->num_uf($request->get('discount_amount'));
            $input['total_before_tax'] = $this->commonUtil->num_uf($request->get('total_before_tax'));
            $input['final_total'] = $this->commonUtil->num_uf($request->get('final_total'));
