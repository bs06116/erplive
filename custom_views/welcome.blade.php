                ...
                <div class="row" style="display: flex">
                   ...
                   <span class=" tablink"  id="" onclick="openPage('year')"> Yearly </span>
                        ...
                        <ul class="nav-pills nav-stacked l1">
                            <li id="s1"><a id="l1"  class="tablink" href="#priceplanning" onclick=" myFunction(), openPage('pos')"> POS Lite </a></li>
                            <li id="s2"><a id="l2"  class="tablink" href="#priceplanning" onclick=" aFunction(),openPage('pos2')">POS Basic</a></li>
                            <li id="s3"><a id="l3"  class="tablink" href="#priceplanning" onclick=" bFunction(),openPage('pos3')" > POS Professional</a></li>
                            <li id="s4"><a id="l4"  class="tablink" href="#priceplanning" onclick=" cFunction(),openPage('woo')">POS with WooCommerce( 1 location)</a></li>
